...
@Component({
  selector: 'jhi-confim-modal-img',
  templateUrl: './confim-modal-img.component.html',
  styleUrls: ['./confim-modal-img.component.scss']
})
export class ConfimModalImgComponent implements OnInit {
